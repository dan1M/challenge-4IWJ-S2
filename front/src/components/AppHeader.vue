        ...
        <div class="flex items-center lg:order-2">
          <DropdownMenu v-if="isLoggedIn">
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem>
                <router-link :to="{ name: 'profile-credentials' }" class="flex items-center">
                  <User class="mr-2 h-4 w-4" />
                  <span>Mon compte</span>
                </router-link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <router-link :to="{ name: 'profile-orders' }" class="flex items-center">
                  <PackageSearch class="mr-2 h-4 w-4" />
                  <span>Mes commandes</span>
                </router-link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <router-link :to="{ name: 'profile-alerts' }" class="flex items-center">
